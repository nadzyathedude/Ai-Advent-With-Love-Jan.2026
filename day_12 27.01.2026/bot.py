...
/mcp\\_tools — показать MCP инструменты
...
/mcp\\_tools — Показать MCP инструменты Perplexity
/tasks — Количество открытых задач (MCP)
/task\\_add — Добавить новую задачу
/task\\_list — Список открытых задач
/task\\_done — Завершить задачу
/task\\_tools — Показать инструменты Task Tracker
...
def main() -> None:
    ...
    # Инициализируем Task Tracker MCP клиент
    init_task_tracker_client()
